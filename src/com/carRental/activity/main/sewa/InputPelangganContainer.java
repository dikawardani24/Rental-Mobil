 ...
 * @author dika
 */
public interface InputPelangganContainer extends InputContainer<Panel> {
    
    TextField getNamaPelangganField();

    TextField getNoKtpField();
    
    TextField getNoTelpField();

    Button getSearchlPelangganButton();

    @Override
    default List<JTextComponent> getTextComponents() {
        return CollectionHelper.INSTANCE.collectAsArrayList(
                getNamaPelangganField(),
                getNoKtpField(),
                getNoTelpField()
        );
    }
