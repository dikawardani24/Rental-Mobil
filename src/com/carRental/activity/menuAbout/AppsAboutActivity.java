...
public class AppsAboutActivity extends Activity<AppsAboutView> {
    private final AppsAboutView view = new AppsAboutView();
    ...
    protected void initListener(AppsAboutView v) {
        ...
        view.getDetailTextPane().setContentType(HtmlTextRes.INSTANCE.getType());
        view.getDetailTextPane().setText(HtmlTextRes.INSTANCE.getAppAbout());
    }
}
