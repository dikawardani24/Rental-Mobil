 ...
 * @author dika
 */
public interface PelangganManagerView extends View<Frame> {
    Button getAddNewPelangganButton();

    Button getPrintButton();

    PagingTableView getPagingTableView();

    WebMenuItem getUpdatePelangganMenuItem();

    WebMenuItem getDeletePelangganMenuItem();
}
